## Regional overlap analysis function for species polygons
## Collaborator: Casey Visintin

polygon_region_overlap <- function(species_name, species_poly, shapefile_dir, region_vals, region_classes, outdir){
